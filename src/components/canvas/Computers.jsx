...
const Computers = ({ isMobile }) => {
  ...
  return (
    <mesh>
      ...
      {/* Reduce spotLight usage or intensity for mobile */}
      <spotLight
        position={[-20, 50, 10]}
        angle={0.12}
        penumbra={1}
      ...
      />
      <pointLight intensity={isMobile ? 0.5 : 1} /> {/* Adjust intensity for mobile */}
      <primitive
...
const ComputersCanvas = () => {
  ...
  return (
    <Canvas
      ...
      dpr={isMobile ? [1, 1] : [1, 2]} // Adjust dpr for mobile
